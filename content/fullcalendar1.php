    ...
    <script type="text/javascript">
            $(function() {
                $('#calendar').fullCalendar({
                    ...
                    editable: true,
                    theme: true,
                    events: "../template/plugins/fullcalendar/data_events.php?gData=1",
...
<a style="background-color:<?= $code_color[$i]?>; color: white"><?= $result[$I]['fullname']?></a> 
<?php $i++; }?>
</div>
...
<script type="text/javascript" src="../template/plugins/fullcalendar/script.js"></script>            
</body>
</html>